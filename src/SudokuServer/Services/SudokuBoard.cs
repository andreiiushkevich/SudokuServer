...
namespace SudokuServer.Services
{
    public class SudokuBoard
    {
        ...
        /// </summary>
        public int TOTAL_CELLS => TOTAL_ROWS * TOTAL_COLUMNS;
        ...
        private void InitializeCells()
        {
            ...
            for (var y = 0; y < TOTAL_COLUMNS; y++)
                Cells.Add(new Cell(
                    index: x * TOTAL_ROWS + y,
                    groupNo: x / 3 + 3 * (y / 3) + 1,
                    value: -1,
                    position: new Cell.RCPosition(x + 1, y + 1)
                ));
        }
        ...
        ///     Index of the cell to return. (The index value indicates the position of the cell on the board.
        ///     0 for the first column of the first row, 1 for the second column of the first row and so on...)
        /// </param>
        ...
        /// <param name="cellIndex">
        ///     Index of the cell specified. (The index value indicates the position of the cell on the board.
        ///     0 for the first column of the first row, 1 for the second column of the first row and so on... )
        /// </param>
        ...
        {
            return Cells.FirstOrDefault(cell => cell.Value == -1) == null;
        }
        ...
        public void Clear()
        {
            Cells.ForEach(cell => SetCellValue(-1, cell.Index));
        }
    }
}